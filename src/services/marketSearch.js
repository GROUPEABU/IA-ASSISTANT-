...
POSITIONNEMENT PRIX OBLIGATOIRE : identifie les prix les plus compétitifs du marché (premiers du net, bas du cluster réaliste, hors aberrations ; le « top 20 % des annonces les moins chères » n'illustre que ce niveau, ce n'est pas une cible distincte). Recommande un prix de vente TTC positionné AU NIVEAU des premiers du net (au plus bas du cluster réaliste), pour placer les partenaires parmi les offres les plus attractives visibles sur La Centrale / LeBonCoin / AutoScout24 — JAMAIS sur la moyenne haute du marché. Les partenaires achètent en volume à prix HT et doivent transmettre cet avantage en prix TTC compétitif.
